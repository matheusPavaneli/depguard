export const POPULAR_PACKAGE_NAMES_RAW: string[] = [
  ...
  "@xverse/log",
  "@xyflow/react",
  "@yarn-tool/yarn-struct-utils",
  "@yarn-tool/yarnlock-error",
  "@yarn-tool/yarnlock-parse-assert",
  "@yarn-tool/yarnlock-types",
